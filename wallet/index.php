<?php
	/*
	* This page displayes all wallet recharge request.
	*/
...
<body>
	...
	<div class="container">
		<div class="pt-4 add-n">
			Note: Choose a plan and book your request. Our executives will reach to you and wallet system will be avtivated after collecting cash from you.<br/><br/>
			<b>Facilities</b><br/>
    ...
    <div class="container pt-4">
		<div class="row">
		<?php
			$wallet = "select wlt_id, wlt_rupees, wlt_amount from wallet";
						...
						<div class="card-footer">
							 <div class="d-flex mb-1 buttoning">
								<div class="p-1 mr-auto">
									<a href="confirm-booking.php?wlt_id=<?php echo $wallet_row['wlt_id'];?>">
										<button class="btn btn-sm btn-warning text-dark" id="left" style="color:white">
											Book
										</button>
									</a>
								</div>
