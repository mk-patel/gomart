<?php
	/*
	* This page displayes wallet data.
	*/
	...
	<div class="container">
		<div class="p-2 d-flex justify-content-center">
			<div class="col-sm-2 mt-3 mb-3">
				<a href="wallet-recharge-request.php">
					<div class="flash-wtr">
						<div class="flash-head-wtr h3 p-5 text-center">
							<?php
		...
		<div class="row pt-3">
			<div class="col-sm-6 border">
				<form id="add_new_products" autocomplete="on" enctype="multipart/form-data">
					<div class="form-group pt-4">
						...
						<input type="text" class="form-control" id="wlt_rupees" name="wlt_rupees" placeholder="2000" required>
						<div class="valid-feedback">Valid.</div>
						<div class="invalid-feedback">Please fill out this field.</div>
					</div>
					<div class="form-group pt-2">
						<label for="uname" class="lable-title">Wallet Cash</label>
						<input type="text" class="form-control" id="wlt_amount" name="wlt_amount" placeholder="5000" required>
						<div class="valid-feedback">Valid.</div>
						<div class="invalid-feedback">Please fill out this field.</div>
					</div>
					<br/>
			...
			<p class="pt-5">Offers Running</p><br>
			<?php
				$select = "select wlt_id, wlt_rupees, wlt_amount from wallet order by wlt_id desc";
				$select_result = mysqli_query($conn, $select);
				if(mysqli_num_rows($select_result)<= 0){
					echo "No Offers Yet.";
				}else{
					while($wlt_row = mysqli_fetch_assoc($select_result)){
			?>
				<div class="p-3 border rounded mb-3">
					<div class="">Rupees : <?php echo $wlt_row['wlt_rupees'];?></div>
					<div class="">Wallet Cash : <?php echo $wlt_row['wlt_amount'];?></div>
					<hr/> 
					<div class="bg-light mb-5"><a href="edit-wallet.php?wlt_id=<?php echo $wlt_row['wlt_id'];?>"><button class="btn btn-primary float-left">Edit</button></a><a href="delete-wallet.php?wlt_id=<?php echo $wlt_row['wlt_id'];?>"><button class="btn btn-warning float-right">Delete</button></a></div>
				</div>
