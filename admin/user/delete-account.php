<?php
	/*
	* This page deletes account permanently.
	*/
			...
			?>
               <div class="col-12 border rounded p-2">
					<div class="text-center p-4">
						Are You Sure ? It will delete all his account details.
					</div>
					<div class="text-center p-4">
						<a href="permanent-deletion.php?uid=<?php echo $user_id;?>"><button class="btn btn-danger text-light">Permanently Delete Account</button></a>
					</div>
			   </div>
            </div>
        </div>
