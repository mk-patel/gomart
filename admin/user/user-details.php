...
<body>
    ...
    <header class="navigation fix-nav">
        ...
        <div class="logo-img">
			...
			<span class="p-1 ml-2 search-bar-header">
				<input class="rounded search-input" type="text" name="search-header" id="search" placeholder="&nbsp;&nbsp;Search By Name or Mobile">
			</span>
        </div>
        <!--right-menu----------->
	...
	<div class="pt-1 search-bar">
		<input class="rounded search-input" type="text" name="search" id="search-header" placeholder="&nbsp;&nbsp;Search By Name or Mobile">
	</div>
     <!--Body----------->
    <section class="home-body-content">
        <div class="container">
            <div class="row">
			<?php
				$user = "select user_id, user_full_name, mobile_number, user_dob, user_gender from user order by user_id desc";
				$user_result = mysqli_query($conn, $user);
				if(mysqli_num_rows($user_result)<=0)
					echo "<div class='text-center p-4'>No Users Yet.</div>";
				else{
