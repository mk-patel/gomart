<?php
	/*
	* This page provide interface to add new products.
	*/
		...
		<form id="add_new_products" autocomplete="on" enctype="multipart/form-data">
			<div class="address-body p-3 ">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="pr_offers" placeholder="Buy 5 kg get 250 gram free" name="pr_offers">
					<div class="valid-feedback">Valid.</div>
					<div class="invalid-feedback">Please fill out this field.</div>
				</div>
				<div class="form-group pt-4">
					<label for="uname" class="lable-title">Product Name *</label>
					<input type="text" class="form-control" id="pr_name" placeholder="Product Name" name="pr_name" required autofocus>
					<div class="valid-feedback">Valid.</div>
					<div class="invalid-feedback">Please fill out this field.</div>
				</div>
				<div class="form-group">
					...
					<div class="row">
                        <div class="col-lg-8">
							<input type="text" class="form-control" id="pr_actual_price" placeholder="60" name="pr_actual_price" required>
							<div class="valid-feedback">Valid.</div>
							<div class="invalid-feedback">Please fill out this field.</div>
                        </div>
                        <div class="col-lg-4">
				...
				<div class="form-group">
					...
					<div class="row">
                        <div class="col-lg-8">
							<input type="text" class="form-control" id="pr_effective_price" placeholder="40" name="pr_effective_price" required>
							<div class="valid-feedback">Valid.</div>
							<div class="invalid-feedback">Please fill out this field.</div>
                        </div>
                        <div class="col-lg-4">
                ...
                <div class="form-group">
					...
					<input type="text" class="form-control" id="pr_discount" placeholder="25" name="pr_discount" required>
					<div class="valid-feedback">Valid.</div>
					<div class="invalid-feedback">Please fill out this field.</div>
				</div>
				<div class="form-group">
					<label for="uname" class="lable-title"><b>Wallet Discount *</b></label>
					<input type="text" class="form-control" id="pr_wallet_disc" placeholder="4" name="pr_wallet_disc" required>
					<div class="valid-feedback">Valid.</div>
					<div class="invalid-feedback">Please fill out this field.</div>
				</div>
				<div class="form-group">
					<label for="uname" class="lable-title">Returns</label>
					<input type="text" class="form-control" id="pr_returns" placeholder="Within 6 Hours" name="pr_returns">
					<div class="valid-feedback">Valid.</div>
					<div class="invalid-feedback">Please fill out this field.</div>
				</div>
				<div class="form-group">
					<label for="uname" class="lable-title">Total Stock</label>
					<input type="number" class="form-control" id="pr_stock_count" placeholder="19" name="pr_stock_count">
					<div class="valid-feedback">Valid.</div>
					<div class="invalid-feedback">Please fill out this field.</div>
				</div>
				<div class="form-group">
					<label for="uname" class="lable-title">Product Description</label>
					<textarea type="text" rows="3" class="form-control" id="pr_desc" placeholder="Product Description" name="pr_desc"></textarea>
					<div class="valid-feedback">Valid.</div>
					<div class="invalid-feedback">Please fill out this field.</div>
				</div>
                <div class="form-group">
					<label for="uname" class="lable-title">Product Image *</label>
