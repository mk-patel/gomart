...
<body> 
	...
	<div class="container">
		<!--<div class="pt-5 pb-5">
			Note : Image size should be in <b>Square</b> and less then <b>100 kb</b>
		</div>-->
		<div class="row pt-3">
			<div class="col-sm-6 border">
				<form id="add_new_products" autocomplete="on" enctype="multipart/form-data">
					<div class="form-group pt-4">
						<label for="uname" class="lable-title">Area/Location Name</label>
						<input type="text" class="form-control" id="loc_name" name="loc_name" placeholder="Raipur" required>
						<div class="valid-feedback">Valid.</div>
						<div class="invalid-feedback">Please fill out this field.</div>
					</div>
					<div class="form-group pt-2">
						<label for="uname" class="lable-title">District</label>
						<input type="text" class="form-control" id="loc_district" name="loc_district" placeholder="Raipur" required>
						<div class="valid-feedback">Valid.</div>
						<div class="invalid-feedback">Please fill out this field.</div>
					</div>
					<div class="form-group pt-2">
						<label for="uname" class="lable-title">State</label>
						<input type="text" class="form-control" id="loc_state" name="loc_state" placeholder="Chhattisgarh" required>
						<div class="valid-feedback">Valid.</div>
						<div class="invalid-feedback">Please fill out this field.</div>
					</div>
					<div class="form-group pt-2">
						<label for="uname" class="lable-title">Postal Pincode</label>
						<input type="text" class="form-control" id="loc_pincode" name="loc_pincode" placeholder="493221" required>
						<div class="valid-feedback">Valid.</div>
						<div class="invalid-feedback">Please fill out this field.</div>
					</div>
					<br/>
			...
			<p class="pt-5">Service Locations Running</p><br>
			<?php
			...
			?>
				<div class="p-3 border rounded mb-3">
					<div class="">Area : <?php echo $loc_row['loc_name'];?></div>
					<div class="">District : <?php echo $loc_row['loc_district'];?></div>
					<div class="">State : <?php echo $loc_row['loc_state'];?></div>
					<div class="">Pincode : <?php echo $loc_row['loc_pincode'];?></div>
					<hr/> 
					<div class="bg-light mb-5"><a href="edit-area.php?loc_id=<?php echo $loc_row['loc_id'];?>"><button class="btn btn-primary float-left">Edit</button></a><a href="delete-area.php?loc_id=<?php echo $loc_row['loc_id'];?>"><button class="btn btn-warning float-right">Delete</button></a></div>
				</div>
