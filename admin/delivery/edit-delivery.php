<?php
	...
	*/
	...
	if(isset($_REQUEST['dlr_id'])){
		$dlr_id = $_REQUEST['dlr_id'];
	}
?>
<!DOCTYPE html>
<html lang="en">
	...
	<div class="container">
		...
		<div class="row pt-3">
			<div class="col-sm-6 border">
				<?php
				$select = "select dlr_charge, dlr_time,dlr_charge_wallet, dlr_time_wallet,loc_id, loc_name, loc_district, loc_state, loc_pincode from delivery inner join service_location on loc_id=dlr_loc_id where dlr_id=$dlr_id";
				$select_result = mysqli_query($conn, $select);
				$dlr_row = mysqli_fetch_assoc($select_result);
				?>
				<form id="add_new_products" autocomplete="on" enctype="multipart/form-data">
					<div class="form-group pt-2">
						...
						<input type="text" class="form-control" id="dlr_charge" name="dlr_charge" placeholder="40" value="<?php echo $dlr_row['dlr_charge'];?>" required>
						<div class="valid-feedback">Valid.</div>
						<div class="invalid-feedback">Please fill out this field.</div>
					</div>
					<div class="form-group pt-2">
						<label for="uname" class="lable-title">Delivery Time</label>
						<input type="text" class="form-control" id="dlr_time" name="dlr_time" placeholder="Within 2 days after order placed" value="<?php echo $dlr_row['dlr_time'];?>" required>
						<div class="valid-feedback">Valid.</div>
						<div class="invalid-feedback">Please fill out this field.</div>
					</div>
					<br/>
					<div class="form-group pt-2">
						...
						<input type="text" class="form-control" id="dlr_charge" name="dlr_charge_wallet" placeholder="30" value="<?php echo $dlr_row['dlr_charge_wallet'];?>" required>
						<div class="valid-feedback">Valid.</div>
						<div class="invalid-feedback">Please fill out this field.</div>
					</div>
					<div class="form-group pt-2">
						<label for="uname" class="lable-title">Delivery Time for Wallet Owner</label>
						<input type="text" class="form-control" id="dlr_time" name="dlr_time_wallet" placeholder="Within 1 days after order placed" value="<?php echo $dlr_row['dlr_time_wallet'];?>" required>
						<div class="valid-feedback">Valid.</div>
						<div class="invalid-feedback">Please fill out this field.</div>
					</div>
					<br/>
					<input type="hidden" class="form-control" id="dlr_id" name="dlr_id" value="<?php echo $dlr_id;?>" required>
