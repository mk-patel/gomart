	...
	<div class="container">
		...
		<?php
			if(isset($_REQUEST['ct_id'])){
				...
				$ct_select = "select ct_id, ct_name, ct_image from categories where ct_id = $ct_id";
				$ct_result = mysqli_query($conn, $ct_select);
			...
			<div class="col-sm-6 border">
				<form id="add_new_products" autocomplete="on" enctype="multipart/form-data">
					<div class="form-group pt-4">
						...
						<input type="text" class="form-control" id="ct_name" name="ct_name" value="<?php echo $ct_row['ct_name'];?>" required>
						<div class="valid-feedback">Valid.</div>
						<div class="invalid-feedback">Please fill out this field.</div>
					</div>
					<div class="form-group pt-4">
					<img class="ctg-img" src="../../<?php echo $ct_row['ct_image'];?>" alt="category image">
					</div>
					...
					<br/>
					<input type="hidden" class="form-control" id="ct_id" name="ct_id" value="<?php echo $ct_row['ct_id'];?>" required>
