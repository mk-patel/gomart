...
<body> 
	...
	<div class="container">
		...
		<div class="row pt-3">
			<div class="col-sm-6 border">
				<form id="add_new_products" autocomplete="on" enctype="multipart/form-data">
					<div class="form-group pt-4">
						<label for="uname" class="lable-title">Category Name</label>
						<input type="text" class="form-control" id="ct_name" name="ct_name" required>
						<div class="valid-feedback">Valid.</div>
						<div class="invalid-feedback">Please fill out this field.</div>
					</div>
					<div class="form-group pt-4">
						<label for="uname" class="lable-title">Category Image</label>
						<input type="file" class="form-control" id="ct_image" name="ct_image" required>
						<div class="valid-feedback">Valid.</div>
						<div class="invalid-feedback">Please fill out this field.</div>
					</div>
					<br/>
			...
			<p class="pt-5">Category Running</p><br>
			<?php
			...
			?>
				<div class="p-3 border rounded mb-3">
					<img class="ctg-img" src="../../<?php echo $ct_row['ct_image'];?>" alt="category image"><br/>
					<div class=""><?php echo $ct_row['ct_name'];?></div>
					<hr/>
					<div class="bg-light mb-5"><a href="edit-category.php?ct_id=<?php echo $ct_row['ct_id'];?>"><button class="btn btn-primary float-left">Edit</button></a><a href="delete-category.php?ct_id=<?php echo $ct_row['ct_id'];?>"><button class="btn btn-warning float-right">Delete</button></a></div>
				</div>
