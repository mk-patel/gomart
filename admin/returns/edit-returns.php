	...
	<div class="container">
		...
		<div class="row pt-3">
			<div class="col-sm-6 border">
				<?php
				$select = "select rt_time from returns where rt_id=$rt_id";
				$select_result = mysqli_query($conn, $select);
				$rt_row = mysqli_fetch_assoc($select_result);
				?>
				<form id="add_new_products" autocomplete="on" enctype="multipart/form-data">
					<div class="form-group pt-2">
						...
						<input type="text" class="form-control" id="rt_time" name="rt_time" placeholder="Within 1 hour" value="<?php echo $rt_row['rt_time'];?>" required>
						<div class="valid-feedback">Valid.</div>
						<div class="invalid-feedback">Please fill out this field.</div>
					</div>
					<br/>
					<input type="hidden" class="form-control" id="rt_id" name="rt_id" value="<?php echo $rt_id;?>" required>
